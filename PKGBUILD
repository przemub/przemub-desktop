...
depends=(
	...
	'pulseaudio' 'volumeicon' 'pavucontrol' 'pamixer' 'pasystray'
	'firefox' 'thunderbird' 'firefox-i18n-en-gb' 'thunderbird-i18n-en-gb' 'pcmanfm-gtk3' 'compton' 'dunst' 'libnotify'
	'nitrogen' 'polkit-gnome' 'network-manager-applet' 'conky' 'xautolock' 'xfce4-terminal' 'parcellite' 'kdeconnect'
	'bash-completion' 'cronie' 'evince' 'fcitx' 'fcitx-gtk2' 'fcitx-gtk3' 'fcitx-qt5' 'fcitx-mozc' 'vlc' 'lightdm' 'lxappearance-gtk3' 'gvim'
	'python-virtualenv' 'redshift' 'sudo' 'btrfs-progs' 'pkgfile' 'xorg-xrandr' 'xorg-xrdb' 'xorg-xbacklight' 'otf-ipafont' 'otf-hermit' 'blueman'
	'libreoffice-still' 'libreoffice-still-en-gb' 'libreoffice-still-pl'
	)
makedepends=()
optdepends=('xf86-video-intel: GPU driver' 'xf86-video-amdgpu: GPU driver' 'yay: AUR' 'otf-hermit: AUR' 'adapta-maia-theme: AUR' 'lightdm-slick-greeter: AUR' 'command-not-found: AUR')
provides=()
conflicts=()
replaces=()
backup=()
